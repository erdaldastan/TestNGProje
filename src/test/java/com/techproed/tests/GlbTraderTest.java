...
public class GlbTraderTest extends TestBaseFinal {
    ...
    public void urunIsmiVeSayfaTitleKarsilastirmaTesti(){
        ...
        Driver.getDriver().get(ConfigurationReader.getProperty("glbtradersearch_link"));
        ...
        glbTraderPage.searchBox.sendKeys(ConfigurationReader.getProperty("glbtradersearch_word") + Keys.ENTER);

        extentTest.info("3. sıradaki ürünün ismini aldık.");
        String urunIsmi = glbTraderPage.resultList.get(2).getText();

        extentTest.info("3. sıradaki ürüne tıkladık.");
        glbTraderPage.resultList.get(2).click();
