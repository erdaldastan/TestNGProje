...
public class FhcTripHotelRoomCreateTest extends TestBase {
    ...
    public void test01(){
        ...
        page.nameBox.sendKeys("Hamza Yılmaz");
        page.locationBox.sendKeys("Almanya");
        page.descBox.sendKeys("Day 20'den selamlar..");

        Actions actions = new Actions(driver);
        actions.dragAndDrop(page.price500, page.priceBox).perform();
