...
public class Ornek_WebTable extends TestBase {
    ...
    public void test(){
        giris();
        List<WebElement> kacSatirVar = driver.findElements(By.xpath("//tbody/tr"));
        System.out.println("Tabloda " + kacSatirVar.size() + " tane satır vardır.");
        WebElement ucuncuSatirVeriler = driver.findElement(By.xpath("//tbody/tr[3]"));
        System.out.println(ucuncuSatirVeriler.getText());
    }
    public void giris(){
