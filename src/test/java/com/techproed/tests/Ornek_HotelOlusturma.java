...
public class Ornek_HotelOlusturma extends TestBase {
    ...
    public void hotelCreate(){
        ...
        codeKutusu.sendKeys("1357");
        nameKutusu.sendKeys("Erdal");
        adresKutusu.sendKeys("Sokak Sk. No:75/13");
        phoneKutusu.sendKeys("+902122122120");
        emailKutusu.sendKeys("erdal@dastan.com");
